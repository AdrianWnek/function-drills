...
//CODE HERE
let bestMovie = str => {return(str + " is the best movie ever!")}
...
function maxFrogs2(gold){
  if (gold % 3 === 0){
    ...
    return((gold/3) - ((gold%3)/3))
  }
}

totalFrogs2 = maxFrogs2(7)
